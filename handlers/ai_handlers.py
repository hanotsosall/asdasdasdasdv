...
@router.callback_query(Text("ai_groq"))
...
@router.callback_query(Text("ai_deepseek"))
...
@router.message(AIState.waiting_groq, Text())
...
@router.message(AIState.waiting_deepseek, Text())
