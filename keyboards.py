...
def main_menu():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            ...
            InlineKeyboardButton(text="✨ Gemini", callback_data="ai_gemini")   # новая
        ],
        [
        ...
        [
            ...
            InlineKeyboardButton(text="⚙️ Настройки", callback_data="settings")   # новая
        ],
        [
...
def settings_menu(current_ai: str):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(
            text=f"🤖 Основная ИИ: {current_ai.upper()}",
            callback_data="change_default_ai"
        )],
...
def image_model_menu(current_model: str = "pollinations"):
    # current_model: "pollinations" или "nano_banana"
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(
            text=f"🌐 Pollinations {'✅' if current_model=='pollinations' else ''}",
            callback_data="set_image_model_pollinations"
        )],
        [InlineKeyboardButton(
            text=f"🍌 Nano Banana {'✅' if current_model=='nano_banana' else ''}",
            callback_data="set_image_model_nano_banana"
        )],
        [InlineKeyboardButton(text="◀️ Назад", callback_data="settings")]
    ])
